package com.kothein.mmpoetry.animation;
...
public class Animatool {
    public static void animateListItem(Context context){
        ((Activity) context).overridePendingTransition(
                R.anim.list_item_enter,
                R.anim.list_item_exit
        );
    }
public static void animatePageTurn(Context context){
    ((Activity) context).overridePendingTransition(
            R.anim.page_turn_enter,
            R.anim.page_turn_exit
    );
}
