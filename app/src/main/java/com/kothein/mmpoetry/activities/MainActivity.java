...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        categoryListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                ...
                Animatool.animateSlideLeft(MainActivity.this);
            }
        });
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (itemId == R.id.nav_use) {
            ...
            recreate();
            //startActivity(new Intent(MainActivity.this, ThemeChange2.class));
        }
        drawerLayout.closeDrawer(GravityCompat.START);
        return true;
    }
        ...
        mBuilder.setSingleChoiceItems(listItems, selectedLanguageIndex, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                if (i == 0 && !"en".equals(currentLanguage)) {
                    setLocale("en");
                    recreate();
                    //startActivity(new Intent(MainActivity.this, MainActivityClone.class));
